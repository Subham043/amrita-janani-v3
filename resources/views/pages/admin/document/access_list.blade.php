                            ...
                            <div class="row g-4 mb-3">
                                ...
                                <div class="col-sm row mt-4 justify-content-end">
                                    @include('includes.admin.filter_search_access_form', [
                                        'url' => route('document_view_access'),
                                    ])
                                </div>
                            </div>
                            <div class="table-responsive table-card mt-3 mb-1">
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all">
                                        ...
                                        <tr>
                                            <td class="customer_name"><a href="{{route('document_display', $item->DocumentModel->id)}}" target="_blank" rel="noopener noreferrer">{{$item->DocumentModel->title}}</a></td>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    @if($item->User->user_type == 2)
                                                    <div class="edit">
                                                        <form action="{{route('document_toggle_access', $item->id)}}" method="post">
                                                            @csrf
