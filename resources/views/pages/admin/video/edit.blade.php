                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="live-preview">
                            <form id="countryForm" method="post" action="{{route('video_update', $data->id)}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row gy-4">
  ...
  .onSuccess(async (event) => {
    // event.target.submit();
      ...
      try {
        ...
        const response = await axios.post('{{route('video_update', $data->id)}}', formData)
