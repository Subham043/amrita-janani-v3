                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <div class="flex-shrink-0 d-none" id="video_multiple_action_container">
                            ...
                            <button id="remove_multiple_videos" type="button" class="btn btn-danger">Delete</button>
                    ...
                    <div class="card-body">
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                ...
                                <div class="col-sm">
                                    <form  method="get" action="{{route('video_view')}}" class="col-sm-auto d-flex gap-2 justify-content-end">
...
<script type="text/javascript" nonce="{{ csp_nonce() }}">
    ...
    const active_multiple_action_handler = (status = 1) => {
        iziToast.question({
            ...
            zindex: 999,
            title: 'Hey',
            message: status ? 'Are you sure about making the selected videos active?' : 'Are you sure about making the selected videos inactive?',
            position: 'center',
            buttons: [
    ...
    const restricted_multiple_action_handler = (restricted = 0) => {
        iziToast.question({
            ...
            zindex: 999,
            title: 'Hey',
            message: restricted ? 'Are you sure about restricting the selected videos?' : 'Are you sure about unrestricting the selected videos?',
            position: 'center',
            buttons: [
                ['<button><b>YES</b></button>', async function(instance, toast) {
    ...
    const remove_multiple_action_handler = () => {
        iziToast.question({
            ...
            zindex: 999,
            title: 'Hey',
            message: 'Are you sure about deleting the selected videos?',
            position: 'center',
            buttons: [
                ['<button><b>YES</b></button>', async function(instance, toast) {
