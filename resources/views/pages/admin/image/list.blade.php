                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <div class="flex-shrink-0 d-none" id="image_multiple_action_container">
                            ...
                            <button id="remove_multiple_images" type="button" class="btn btn-danger">Delete</button>
                            ...
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        ...
                                        <a href="{{route('image_excel')}}?{{ request()->getQueryString() }}" download type="button" class="btn btn-info add-btn" id="create-btn"><i class="ri-file-excel-fill align-bottom me-1"></i> Excel</a>
...
<script type="text/javascript" nonce="{{ csp_nonce() }}">
    ...
    const active_multiple_action_handler = (status = 1) => {
        iziToast.question({
            ...
            zindex: 999,
            title: 'Hey',
            message: status ? 'Are you sure about making the selected images active?' : 'Are you sure about making the selected images inactive?',
            position: 'center',
            buttons: [
    ...
    const restricted_multiple_action_handler = (restricted = 0) => {
        iziToast.question({
            ...
            zindex: 999,
            title: 'Hey',
            message: restricted ? 'Are you sure about restricting the selected images?' : 'Are you sure about unrestricting the selected images?',
            position: 'center',
            buttons: [
                ['<button><b>YES</b></button>', async function(instance, toast) {
    ...
    const remove_multiple_action_handler = () => {
        iziToast.question({
            ...
            zindex: 999,
            title: 'Hey',
            message: 'Are you sure about deleting the selected images?',
            position: 'center',
            buttons: [
                ['<button><b>YES</b></button>', async function(instance, toast) {
