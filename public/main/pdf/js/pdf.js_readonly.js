...
if ( disablePrintPdf ) {
  $.getScript( baseUrl + '/main/pdf/jscript/viewer_noprint.js' ); // Adjust path to viewer_noprint.js if necessary
} else {
  $.getScript( baseUrl + '/main/pdf/jscript/viewer.js' );  // Adjust path to viewer.js if necessary
}
