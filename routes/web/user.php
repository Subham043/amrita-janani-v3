...
use App\Modules\Account\Controllers\UserAccountController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('/')->middleware(['verified', 'password_is_set', 'is_not_blocked'])->group(function () {
        ...
        Route::prefix('/user')->group(function () {
            ...
            Route::get('/profile', [UserAccountController::class, 'index', 'as' => 'profile.index'])->name('userprofile');
        ...
        Route::prefix('/content')->group(function () {
            ...
            Route::prefix('/image')->group(function () {
                ...
                Route::get('/thumbnail/{uuid}', [ImageContentController::class, 'imageThumbnail', 'as' => 'image.imageThumbnail'])->name('content_image_thumbnail_file');
            });
